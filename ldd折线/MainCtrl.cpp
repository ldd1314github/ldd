...
void MainCtrl::ReadFromFile(string filename)
{
	...
	while (!GraphFile.eof())
	{
		...
		//<EFBFBD><EFBFBD>ͼ<EFBFBD><EFBFBD><EFBFBD><EFBFBD><EFBFBD>ݶ<EFBFBD><EFBFBD><EFBFBD>GraphData
		GraphData.push_back(line);
	}
	GraphFile.close();
	//init ͼ<EFBFBD><EFBFBD><EFBFBD>б<EFBFBD>
...
void MainCtrl::SaveToFile(string filename)
{
	...
	file.close();
	cout << "#CGP# ͼ<EFBFBD><EFBFBD><EFBFBD><EFBFBD><EFBFBD>ݱ<EFBFBD><EFBFBD><EFBFBD><EFBFBD>ɹ<EFBFBD><EFBFBD><EFBFBD> ";
}
...
{
	//<EFBFBD>ַ<EFBFBD><EFBFBD><EFBFBD>s<EFBFBD><EFBFBD><EFBFBD><EFBFBD><EFBFBD>磨0<EFBFBD><EFBFBD>0<EFBFBD><EFBFBD>0<EFBFBD><EFBFBD><EFBFBD>ı<EFBFBD>ʾ<EFBFBD><EFBFBD>ɫ<EFBFBD><EFBFBD><EFBFBD>ַ<EFBFBD><EFBFBD><EFBFBD>
