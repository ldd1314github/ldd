...
{
	//<EFBFBD>Ե<EFBFBD>һ<EFBFBD><EFBFBD><EFBFBD><EFBFBD><EFBFBD><EFBFBD>Ϊ<EFBFBD><EFBFBD><EFBFBD>㣬<EFBFBD>Ӵ<EFBFBD><EFBFBD><EFBFBD><EFBFBD><EFBFBD><EFBFBD><EFBFBD><EFBFBD><EFBFBD><EFBFBD><EFBFBD><EFBFBD><EFBFBD><EFBFBD><EFBFBD>
	for (unsigned int i = 0; i < Vertex.size() - 1; i++)
	{
	...
	//<EFBFBD><EFBFBD><EFBFBD>¸<EFBFBD><EFBFBD>㵽<EFBFBD><EFBFBD>һ<EFBFBD><EFBFBD><EFBFBD><EFBFBD><EFBFBD>ľ<EFBFBD><EFBFBD><EFBFBD><EFBFBD>ͷ<EFBFBD><EFBFBD><EFBFBD><EFBFBD><EFBFBD><EFBFBD><EFBFBD>
	for (unsigned int i = 0; i < Vertex.size() - 1; i++)
		length[i] = sqrt(pow((Vertex[i + 1].Y - Vertex[0].Y), 2) + pow((Vertex[i + 1].X - Vertex[0].X), 2));
	for (unsigned int i = 0; i < Vertex.size() - 1; i++)
	{
